...
declare -A WAIVED=(
    ...
    # ⚑ `mutate_check.sh` was parked here for one commit (5e4da12) and is now invoked by
    # `//ratchet:mutants`; this checker caught it landing unwired, correctly, and sees the label now.
